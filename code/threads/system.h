...
#define INITIAL_TAU \
    SystemTick  // Initial guess of the burst is set to the overhead of system
// activity
#define ALPHA 0.5

#define MAX_NICE_PRIORITY 100  // Default nice value (used by UNIX scheduler)
#define MIN_NICE_PRIORITY 0    // Highest input priority
#define DEFAULT_BASE_PRIORITY \
    50  // Default base priority (used by UNIX scheduler)
...
extern unsigned
    thread_index;                          // Index into this array (also used to assign unique pid)
extern bool initializedConsoleSemaphores;  // Used to initialize the semaphores
// for console I/O exactly once
